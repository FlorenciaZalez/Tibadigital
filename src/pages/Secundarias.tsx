...
const Secundarias = () => {
  ...
  useEffect(() => {
    document.title = "Cuentas Secundarias | TIBADIGITAL";
    setLoading(true);
    supabase
      .from("products")
      .select("*")
  ...
  return (
    <div className="container py-12">
      <div className="mb-10 space-y-3">
        <div className="text-xs uppercase tracking-[0.3em] text-secondary font-display">// Cuentas compartidas</div>
        <h1 className="font-display font-black text-4xl md:text-6xl">
          CUENTAS <span className="text-gradient-neon">SECUNDARIAS</span>
        </h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 card-cyber rounded-2xl">
          ...
          <p className="text-muted-foreground">Próximamente cuentas disponibles.</p>
        </div>
      ) : (
        <>
