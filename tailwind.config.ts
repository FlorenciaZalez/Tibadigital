    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { boxShadow: "0 0 40px hsl(var(--primary) / 0.7), 0 0 80px hsl(var(--primary) / 0.4)" },
        },
        "text-glow": {
          "0%, 100%": { textShadow: "0 0 10px hsl(var(--primary) / 0.7), 0 0 20px hsl(var(--primary) / 0.5)" },
          "50%": { textShadow: "0 0 20px hsl(var(--primary) / 0.9), 0 0 40px hsl(var(--primary) / 0.7)" },
        },
